...
| # | Punto | Estado | Notas |
|---|-------|--------|-------|
| B1 | Fórmula base: aditiva ponderada vs multiplicativa vs híbrida | ⬜ | mvp.md propone pesos % |
| B2 | Pesos iniciales y justificación | ⬜ | mvp.md: tabla orientativa |
| B3 | Definición del corredor direccional (longitud, ancho, puntos de muestreo) | ⬜ | mvp.md: concepto descrito |
| B4 | Penalización por altitud solar baja: umbral y curva | ⬜ | — |
